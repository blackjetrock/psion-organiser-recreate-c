...
#define NOPL_MAX_TOKEN           100
#define NOPL_MAX_OP_STACK        50
#define NOPL_MAX_LOCAL           32
#define NOPL_MAX_GLOBAL          32
...
{
  char                    name[NOBJ_STRING_MAXLEN];  // Needs to be large as we put string literals here
  int                     buf_id;
  NOBJ_INT                integer;
